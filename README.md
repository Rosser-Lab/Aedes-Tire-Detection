...
> Hassan MM\*, Chamberlin AJ\*, Tarpenning MS, Weber WC, Dave Coombe K, De Leo GA, Junaid M, Soma AS, Ansariadi, Rosser JI. **Enhancing *Aedes aegypti* breeding site detection: A deep learning approach to tire identification in unmanned aerial vehicle imagery from urban Indonesia.** *Remote Sensing Applications: Society and Environment*, 2026;42:102011. (\*Co-first authors)
