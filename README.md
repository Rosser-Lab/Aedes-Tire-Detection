...
> Hassan MM\*, Chamberlin AJ\*, Tarpenning MS, Weber WC, Dave Coombe K, De Leo GA, Junaid M, Soma AS, Ansariadi, Rosser JI. **Enhancing *Aedes aegypti* breeding site detection: A deep learning approach to tire identification in unmanned aerial vehicle imagery from urban Indonesia.** (\*Co-first authors)
